    ...
    def place_stone(self, player, point):
        ...
        for neighbor in point.neighbors():
            ...
            if neighbor_string is None: 
                ...
                if neighbor_string not in adj_same_color:
                    adj_same_color.append(neighbor_string)
            else:
                if neighbor_string not in adj_oposite_color:
                    adj_oposite_color.append(neighbor_string)
        ...
        for other_color_string in adj_oposite_color:
            other_color_string.remove_liberty(point)
        for other_color_string in adj_oposite_color:
            if other_color_string.num_lib == 0:
